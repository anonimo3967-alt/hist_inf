...
st.title('Tablero Inteligente', text_alignment="center")
st.text("Esta aplicación tiene la capacidad de interpretar un boceto. Empieza dibujando en el panel proporcionado por alguna entidad.", text_alignment="center")
...
with col2:
    st.subheader("Referencia de dibujo", text_alignment="center")
    st.text("Podrias intentar dibujar esta imagen de un infante alguna vez olvidado...", text_alignment="center")
...
if st.session_state.analysis_done:
    ...
    if st.button("✨ Crear historia de tristeza"):
        with st.spinner("Creando historia..."):
